...
def initialize_display(animal):
    ...
    num_cells = animal.brain.tm_info.dimensions[0]
    tm_depth = animal.brain.tm.getCellsPerColumn()
...
def display_active_cells(animal):
    active_cells = animal.brain.tm.getActiveCells()
...
def display_active_freq(animal):
    active_freq = animal.brain.tm_info.activationFrequency.activationFrequency
    grid = initialize_display(animal)
